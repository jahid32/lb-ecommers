                ...
                <div class="hero-slider hero-slider-one">
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="hero-image col">
                                <img src="{{asset('front/assets')}}/images/hero/hero-1.png" alt="Hero Image">
                            </div>
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <!-- Hero Image -->
                            <div class="hero-image col">
                                <img src="{{asset('front/assets')}}/images/hero/hero-2.png" alt="Hero Image">
                            </div>
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <!-- Hero Image -->
                            <div class="hero-image col">
                                <img src="{{asset('front/assets')}}/images/hero/hero-3.png" alt="Hero Image">
                            </div>
